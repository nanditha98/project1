...
function Side(){
    return(
        <section className="container-fluid">
            ...
            <div className="navbar-subtoggle"><a id="offcanvas-subtoggle" data-toggle="offcanvas" data-target="#submenu" aria-expanded="false" className="navbar-toggle offcanvas-toggle"> <i className="fa fa-filter" aria-hidden="true"></i>&nbsp;Filter </a></div>
            <div id="offcanvas-left-overlay"></div>
            <nav id="submenu" className="navbar-offcanvas-left navbar-offcanvas navbar-offcanvas-submenu" role="navigation">
            <div className="panel panel-primary">
            <h2><i className="fa fa-filter" aria-hidden="true"></i> &nbsp;FILTER</h2>
            <div className="panel-heading panel_trigger active"> <a href="#">By Category</a> </div>
            <div className="panel-body panel_content">
            <div className="cat-menu">
            <ul className="metismenu catmenu checkbox checkbox-primary">	
            <li>
        <input value= "123456789%2F3" type="checkbox" name="checkbox" id= "resource_checkbox1"  
        onClick="onCollectionSpecificFilter(this.id)"/>
       <label for="resource_checkbox1">Public Records (2801286)</label>
        </li>    
        <li>
      <input value= "123456789%2F4" type="checkbox" name="checkbox" id= "resource_checkbox2"  
      onClick="onCollectionSpecificFilter(this.id)"/>
    ...
    <input value= "123456789%2F6" type="checkbox" name="checkbox" id= "resource_checkbox4"  
     ...
     <li>
     <input value= "123456789%2F2763466" type="checkbox" name="checkbox" id= "resource_checkbox5"  
      onClick="onCollectionSpecificFilter(this.id)"/>
 ...
 <label for="resource_checkbox6">Library Collection (3945)</label>
    ...
    <label for="keywords_1">Finance Department (3805)</label>
     ...
     <li>
	<input className="filter" type="checkbox" name="keywords_2" id="keywords_2"  value="Simla" 
    onclick="onOtherFilterQuery(this.id);"/>
...
<div className="panel-heading panel_trigger active"><a href="#">
                                    ...
                                    <div className="panel-body panel_content">
                                        <div className="cat-menu">
                                            ...
                                            <ul className="metismenu catmenu checkbox checkbox-primary">
													...
													<li>
														<input className="filter" type="checkbox" name="fileType_1" id="fileType_1"  value="DOD" onclick="onOtherFilterQuery(this.id);"/>
														<label for="fileType_1">Non Digitized Documents (2685019)</label>
							                        </li>
		
													<li>
														<input className="filter" type="checkbox" name="fileType_2" id="fileType_2"  value="PDF" onclick="onOtherFilterQuery(this.id);"/>
														<label for="fileType_2">Digitized Documents (127227)</label>
							                        </li>
		
													<li>
														<input className="filter" type="checkbox" name="fileType_3" id="fileType_3"  value="pdf" onclick="onOtherFilterQuery(this.id);"/>
														<label for="fileType_3">Digitized Documents (756)</label>
							                        </li>
		
													<li>
														<input className="filter" type="checkbox" name="fileType_4" id="fileType_4"  value="Digitized+Public+Records%3B+Foreign+and+Political" onclick="onOtherFilterQuery(this.id);"/>
							...
							<li>
								...
								<ul aria-expanded="false">
									...
									<span class="text-lg-right">
										{/* <b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&amp;moreFacet=morefacet&amp;facetType=department&amp;facetLimit=13&amp;openDepartment=Military" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b> */}
									</span>
								</ul>
							</li>
							...
							<li>
								...
								<ul aria-expanded="false">
									...
									<span class="text-lg-right">
										{/* <b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&ampamp;moreFacet=morefacet&amp;facetType=department&amp;facetLimit=13&amp;openDepartment=Home" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b> */}
									</span>
								</ul>
							</li>
							...
							<li>
								...
								<ul aria-expanded="false">
									...
									<span className="text-lg-right">
										{/* <b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&amp;moreFacet=morefacet&amp;facetType=department&amp;facetLimit=13&amp;openDepartment=Foreign" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b> */}
									</span>
								</ul>
							</li>
							...
							<li>
								...
								<ul aria-expanded="false">
									...
									<span className="text-lg-right">
										{/* <b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&amp;moreFacet=morefacet&amp;facetType=department&amp;facetLimit=13&amp;openDepartment=Dgims" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b> */}
									</span>
								</ul>
							</li>
							...
							<li>
								...
								<ul aria-expanded="false">
									...
									<span className="text-lg-right">
										{/* <b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&amp;moreFacet=morefacet&amp;facetType=department&amp;facetLimit=13&amp;openDepartment=Foreign+%26+Political" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b> */}
									</span>
								</ul>
							</li>
							
												{/* <li class="text-lg-right">
													<b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&amp;moreFacet=morefacet&amp;facetType=department&amp;facetLimit=13" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b>
												</li> */}
                                    ...
                                    <div className="panel-body panel_content">
                                        <div className="cat-menu">
                                            ...
                                            <ul className="metismenu catmenu checkbox checkbox-primary">
												...
												{/* <li class="text-lg-right">
													<b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&amp;moreFacet=morefacet&amp;facetType=place&amp;facetLimit=13" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b>
												</li> */}
                                    ...
                                    <div className="panel-body panel_content">
                                        <div className="cat-menu">
                                            ...
                                            <ul className="metismenu catmenu checkbox checkbox-primary">
												...
												{/* <li class="text-lg-right">
													<b><a href="/jspui/simple-search?location=&amp;query=&amp;originalquery=&amp;sort_by=dc.date.accessioned_dt&amp;order=desc&amp;rpp=20&amp;etal=0&amp;moreFacet=morefacet&amp;facetType=subjectCollection&amp;facetLimit=13" class="filter1 fancybox.iframe" style="color: #634a35;">More »</a></b>
												</li> */}
